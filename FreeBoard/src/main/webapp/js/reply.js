...
function addReplyHandlerFnc(e) {
	let reply = document.querySelector('#reply').value; //추가할 댓글 내용
	if (!reply || !logId) {
		alert('필수값이 없습니다.');
		return;
	}
...
/*function createPageList() {
	...
	if (prev)
		...
		list += '<a class="page-link" aria-label="Previous">';
	...
	if (next)
		...
		list += '  <a class="page-link" aria-label="Next">'
